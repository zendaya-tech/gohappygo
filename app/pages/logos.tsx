  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">{t('pages.logos.title')}</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-gray-200 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">{t('pages.logos.main')}</div>
              </div>
            </div>
          ...
          <div className="rounded-2xl border border-gray-200 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">GoHappyGo</div>
                <div className="text-sm text-gray-500">{t('pages.logos.monochrome')}</div>
              </div>
            </div>
          ...
          <div className="rounded-2xl border border-gray-200 p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">GoHappyGo</div>
                <div className="text-sm text-gray-500">{t('pages.logos.outline')}</div>
              </div>
            </div>
