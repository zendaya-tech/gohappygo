  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">{t('pages.transporters.title')}</h1>
          <p className="mt-2 text-gray-600">{t('pages.transporters.subtitle')}</p>
        </div>
            ...
            >
              <div className="mb-5 flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-gray-500">
                    {t('pages.transporters.available')}: {transporter.availableWeight}kg
                  </p>
                </div>
              </div>
              ...
              <div className="mb-4">
                <p className="text-xs font-medium text-gray-500">
                  {t('pages.transporters.routes')}
                </p>
                <div className="mt-1 flex flex-wrap gap-2">
                  {transporter.routes.map((r) => (
                    <span
                      key={r}
              ...
              <div className="flex gap-2">
                <button className="inline-flex w-full items-center justify-center rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-semibold text-white hover transition">
                  {t('pages.transporters.requestTransport')}
                </button>
