...
export default function AvatarMenu({
  ...
  return (
    <div
      ref={ref}
      className="absolute -right-1 md:right-0 top-full mt-2 w-75 md:w-96 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl ring-1 ring-black/5"
      role="menu"
