...
export default function AppDownloadPopover({
  open,
  onClose,
  pinned,
  onTogglePin,
  ...
  return (
    <div
      ...
      role="dialog"
      aria-label={t('header.popovers.download.ariaLabel')}
    >
      <div className="p-4 text-center">
        ...
        <div className="w-40 h-40 mx-auto bg-white rounded-lg flex items-center justify-center mb-3 p-2">
          {qrCodeUrl ? (
            <img
              src={qrCodeUrl}
              alt={t('header.popovers.download.qrAlt')}
        ...
        <p className="text-xs text-gray-500 mb-3">{t('header.popovers.download.scanText')}</p>
      </div>
    </div>
  );
}
