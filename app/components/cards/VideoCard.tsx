...
export default function VideoCard({ title, videoId = 'wyTfWvtGSSY' }: VideoCardProps) {
  ...
  return (
    <>
      <div className="relative bg-black rounded-2xl overflow-hidden h-80 group">
        <img
          src={thumbnailUrl}
          alt={title}
        ...
        <div className="absolute inset-0 flex flex-col justify-between py-3 px-3 bg-gradient-to-t from-black/80 via-black/40 to-transparent group-hover:from-black/90 transition-colors">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="bg-white/20 backdrop-blur-md text-sm w-32 relative text-white px-4 py-2 rounded-lg hover:bg-white/30 transition-colors border border-white/30 cursor-pointer"
            >
