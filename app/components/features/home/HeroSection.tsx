      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
        <div className="order-2 lg:order-1">
          ...
          <p className="text-blue-600 text-xl sm:text-2xl mb-6 sm:mb-8 line-clamp-3 sm:line-clamp-2 font-bold mt-10">
            {t('home.hero.titlePart1')} <span className="text-[#de179c]">GoHappyGo</span>{' '}
        ...
        <div className="hidden md:flex absolute top-18 justify-around gap-[5%] lg:gap-[45%] w-full ">
          <div className="flex flex-col items-center mt-4">
            ...
            <span className="text-blue-600 font-bold text-md lg:text-xl text-nowrap">
              {t('home.hero.searchByDestination')}
            </span>
          </div>
          <div className="flex flex-col lg:flex-row justify-center items-center  ">
            ...
            <span className="text-yellow-500 font-bold text-md lg:text-xl text-nowrap">
              {t('home.hero.searchByFlightNumber')}
            </span>
          </div>
        </div>
      </div>
